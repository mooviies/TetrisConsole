...
public:
    ...
    [[nodiscard]] const std::vector<HighScoreRecord> &highscores() const {
        return _highscores[static_cast<size_t>(config.variant)];
    }
    [[nodiscard]] const std::vector<HighScoreRecord> &highscores(GameVariant v) const {
        return _highscores[static_cast<size_t>(v)];
    }
