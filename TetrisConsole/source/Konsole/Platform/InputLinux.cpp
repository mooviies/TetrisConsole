        ...
        for (ssize_t i = 0; i < n; i++) {
            if (buf[i] == '\033') {
                if (i + 2 < n && buf[i + 1] == '[') {
                    ...
                    if (c == 'A') { pressed.push_back(KeyCode::ArrowUp);    i += 2; }
                    else if (c == 'B') { pressed.push_back(KeyCode::ArrowDown);  i += 2; }
                    else if (c == 'C') { pressed.push_back(KeyCode::ArrowRight); i += 2; }
                    else if (c == 'D') { pressed.push_back(KeyCode::ArrowLeft);  i += 2; }
                    else if (c >= '0' && c <= '9') {
