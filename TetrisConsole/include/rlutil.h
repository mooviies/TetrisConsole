...
const RLUTIL_STRING_T ANSI_BACKGROUND_DARKGREY     = "\033[100m";
const RLUTIL_STRING_T ANSI_BACKGROUND_LIGHTRED     = "\033[101m";
const RLUTIL_STRING_T ANSI_BACKGROUND_LIGHTGREEN   = "\033[102m";
const RLUTIL_STRING_T ANSI_BACKGROUND_LIGHTYELLOW  = "\033[103m";
const RLUTIL_STRING_T ANSI_BACKGROUND_LIGHTBLUE    = "\033[104m";
const RLUTIL_STRING_T ANSI_BACKGROUND_LIGHTMAGENTA = "\033[105m";
const RLUTIL_STRING_T ANSI_BACKGROUND_LIGHTCYAN    = "\033[106m";
const RLUTIL_STRING_T ANSI_BACKGROUND_BRIGHTWHITE  = "\033[107m";
...
RLUTIL_INLINE RLUTIL_STRING_T getANSIBackgroundColor(const int c) {
	switch (c) {
		...
		case DARKGREY     : return ANSI_BACKGROUND_DARKGREY;
		case LIGHTBLUE    : return ANSI_BACKGROUND_LIGHTBLUE;
		case LIGHTGREEN   : return ANSI_BACKGROUND_LIGHTGREEN;
		case LIGHTCYAN    : return ANSI_BACKGROUND_LIGHTCYAN;
		case LIGHTRED     : return ANSI_BACKGROUND_LIGHTRED;
		case LIGHTMAGENTA : return ANSI_BACKGROUND_LIGHTMAGENTA;
		case YELLOW       : return ANSI_BACKGROUND_LIGHTYELLOW;
		case WHITE        : return ANSI_BACKGROUND_BRIGHTWHITE;
		default: return "";
	}
}
